        ...
        return(
            ...
            >
                ...
                >
                  ...
                  >
                    <LineChart width={this.state.chartWidth} height={387}/>
                  </Col>
                  </Row>
                  <br></br>
                  <Row type="flex" align="middle" justify="center" style={{height:'400px'}}>
                    ...
                    <Col span={1}></Col>
                     ...
                     <Col 
                        ...
                        style={{background:'white',height:'100%',padding:'0 5% 0 0%'}}      
                    >
                      <LineChart width={this.state.chartWidth} height={387} dashed={true}/>
                    </Col>

                  </Row>
                  <br></br>
                  <Row type="flex" align="middle" style={{height:'400px'}}>
                    <Col 
                      xs={{span: 21}} 
                      sm={{span: 21}} 
                      md={{span: 21}}
